...
int main_code(int argc, char** argv)
{
    ...
    if (out_html && !out_html_no_head)
    {
        cout << "<!DOCTYPE html>\n"
             ...
             << "`</title>\n"
                ...
                "charset=utf-8\"/>\n"
                "<script "
                "src=\"//ajax.googleapis.com/ajax/libs/jquery/1.12.0/"
                "jquery.min.js\"></script>\n"
                "<script "
                "src=\"//cdnjs.cloudflare.com/ajax/libs/gsap/1.18.0/"
    ...
    if (out_html && !out_html_no_head)
    {
        ...
        const string html_tail = openbeam::format(
            "\n<br><br><hr><small>Page generated by OpenBeam (C) "
            "2012-2022</small><br>"
            "<div align=\"right\">"
            " <a href=\"//validator.w3.org/check?uri=referer\">"
            " <img border=\"0\" "
            "src=\"//www.w3.org/Icons/valid-html401-blue\" alt=\"Valid "
