...
inline SwitchArg::SwitchArg(
    ...
    bool _default, Visitor* v)
    : Arg(flag, name, desc, false, false, v), _value(_default)
{
}

inline SwitchArg::SwitchArg(
    const std::string& flag, const std::string& name, const std::string& desc,
    CmdLineInterface& parser, bool _default, Visitor* v)
    : Arg(flag, name, desc, false, false, v), _value(_default)
{
    parser.add(this);
}
...
inline bool SwitchArg::combinedSwitchesMatch(std::string& combinedSwitches)
{
    ...
    if (combinedSwitches[0] != Arg::flagStartString()[0]) return false;
