...
class StdOutput : public CmdLineOutput
{
   ...
   public:
     ...
     */
    StdOutput(std::ostream& desired_out = std::cout) : m_my_output(desired_out)
    {
    }
   ...
   protected:
     ...
     */
    void spacePrint(
        std::ostream& os, const std::string& s, int maxWidth, int indentSpaces,
...
inline void StdOutput::version(CmdLineInterface& _cmd)
{
    ...
    m_my_output << std::endl
                << progName << "  version: " << version << std::endl
                << std::endl;
}
    ...
    CmdLineInterface& _cmd, std::ostream& os) const
{
    ...
    for (ArgListIterator it = argList.begin(); it != argList.end(); it++)
        if (!xorHandler.contains((*it))) s += " " + (*it)->shortID();
