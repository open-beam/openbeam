...
class UnlabeledValueArg : public ValueArg<T>
{
   ...
   public:
     ...
     */
    UnlabeledValueArg(
        const std::string& name, const std::string& desc, bool req, T value,
 ...
 */
template <class T>
UnlabeledValueArg<T>::UnlabeledValueArg(
    const std::string& name, const std::string& desc, bool req, T val,
...
UnlabeledValueArg<T>::UnlabeledValueArg(
    const std::string& name, const std::string& desc, bool req, T val,
    const std::string& typeDesc, CmdLineInterface& parser, bool ignoreable,
    Visitor* v)
    : ValueArg<T>("", name, desc, req, val, typeDesc, v)
{
    _ignoreable = ignoreable;
...
UnlabeledValueArg<T>::UnlabeledValueArg(
    const std::string& name, const std::string& desc, bool req, T val,
    Constraint<T>* constraint, CmdLineInterface& parser, bool ignoreable,
    Visitor* v)
    : ValueArg<T>("", name, desc, req, val, constraint, v)
{
    _ignoreable = ignoreable;
