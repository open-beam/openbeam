...
namespace openbeam
{
/** A spring element with three elastic components in the local X and Y
 * directions, and one torsional axis RZ, between two given nodes.
 */
class CElementSpringDXDYRZ
    : public CElement,
      public std::enable_shared_from_this<CElementSpringDXDYRZ>
{
   public:
    CElementSpringDXDYRZ();
    CElementSpringDXDYRZ(
    ...
    num_t Kx = 0, Ky = 0, KRz = 0;  //!< Stiffness constants of the spring (N/m)
